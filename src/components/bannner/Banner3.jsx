          ...
          <SwiperSlide className="swiper-slide">
            <div className="banner-wrapper">
              <div className="banner-content">
                <h1>Get your apps done easily.</h1>
                <p>
                  Create tasks,monitor and pay easily.Get your work done in
                  highly client friendly environment.
                </p>
                <div className="banner-btn-group">
                  <Link legacyBehavior href="/contact">
                    <a className="primary-btn3">Start Project</a>
                  </Link>
